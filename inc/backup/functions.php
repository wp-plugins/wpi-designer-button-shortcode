...
class WPiCss{
	...
	public static function set_shadow($styles){
		$shadow=false;
		$default=array("text-shadow-color"=>"#000000", "text-shadow-opacity"=>0.3, "text-shadow-x"=>"1px", "text-shadow-y"=>"1px", "text-shadow-blur"=>"1px", "text-shadow-inset"=>"");
		...
		$style=$o["text-shadow-inset"] ." ". $o["text-shadow-x"] ." ". $o["text-shadow-y"] ." ". $o["text-shadow-blur"] ." ". $color;
		if($shadow==true){	

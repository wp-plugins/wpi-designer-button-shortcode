...
class WPiDesButSty{	
	...
	public function fields(){
		...
		$fields=array(		
			...
			array("label"=>"Shape", "name"=>'shape', "type"=>"select", "section"=>"Button Common Settings", "value"=> "", 
				"list"=> array("rectangle"=>"Rectangle", "5px"=>"5px", "7px"=>"7px", "10px"=>"10px","15px"=>"15px","rounded"=>"Rounded")),
			array("label"=>"Padding", "name"=>'padding', "type"=>"select", "section"=>"Button Common Settings", "value"=> "", 
				"list"=> array("3px"=>"3px","5px"=>"5px","7px"=>"7px","10px"=>"10px", "15px"=>"15px", "20px"=>"20px", "30px"=>"30px","40px"=>"40px","50px"=>"50px")),
			array("label"=>"Font", "name"=>'font', "type"=>"select", "section"=>"Button Common Settings", "group"=>"Font", "css_property"=>"font-family", "value"=> "", "list"=> $fonts),
			array("label"=>"Font Weight", "name"=>'font_weight', "type"=>"select", "section"=>"Button Common Settings", "group"=>"Font", "css_property"=>"font-weight", "value"=> "", "list"=> $font_weight),
			array("label"=>"Text Size", "name"=>'text_size', "type"=>"select", "section"=>"Button Common Settings","group"=>"Font", "css_property"=>"font-size", "value"=> "",
				"list"=> $text_size_list),
			array("label"=>"Border Width", "name"=>'border_width', "type"=>"select", "section"=>"Button Common Settings", "group"=>"Border", "css_property"=>"border-width", "value"=> "",				
				"list"=> array("0px"=>"No", "1px"=>"1px", "2px"=>"2px", "3px"=>"3px", "4px"=>"4px","5px"=>"5px","6px"=>"6px","7px"=>"7px","8px"=>"8px","9px"=>"9px","10px"=>"10px")),
			array("label"=>"Border Style", "name"=>'border_style', "type"=>"select", "section"=>"Button Common Settings", "group"=>"Border", "css_property"=>"border-style", "value"=> "", 
				"list"=> array("solid"=>"Solid", "dashed"=>"Dashed", "dotted"=>"Dotted", "double"=>"Double","inset"=>"Inset","outset"=>"Outset")),
			array("label"=>"Border Sides", "name"=>'border_sides', "type"=>"select", "section"=>"Button Common Settings", "group"=>"Border","value"=> "", 
				"list"=> array("all"=>"All Sides", "bottom"=>"Only Bottom",  "top"=>"Only Top", "left"=>"Only Left", "right"=>"Only Right")),
			array("label"=>"Shadow", "name"=>'shadow', "type"=>"select", "section"=>"Button Common Settings", "group"=>"Shadow", "value"=> "", 
				"list"=> array("no"=>"No", "1px"=>"1px", "2px"=>"2px", "3px"=>"3px", "4px"=>"4px","5px"=>"5px","6px"=>"6px","7px"=>"7px","8px"=>"8px","9px"=>"9px","10px"=>"10px","inset_wb"=>"Inset White bottom","inset_wt"=>"Inset White Top","inset_bb"=>"Inset Black Bottom","inset_bt"=>"Inset Black Top")),
			array("label"=>"Text Shadow", "name"=>'text_shadow', "type"=>"select", "section"=>"Button Common Settings", "group"=>"Shadow","value"=> "", 
				"list"=>  array("no"=>"No","1px"=>"1px", "2px"=>"2px", "3px"=>"3px", "4px"=>"4px","5px"=>"5px")),	
			array("label"=>"Glow Size", "name"=>'glow_size', "type"=>"select", "section"=>"Button Common Settings","group"=>"Glow", "css_property"=>"glow", "value"=> "", 
				"list"=> array("no"=>"No", "1px"=>"1px", "2px"=>"2px", "3px"=>"3px", "4px"=>"4px","5px"=>"5px","6px"=>"6px","7px"=>"7px","8px"=>"8px","9px"=>"9px","10px"=>"10px")),
			array("label"=>"Glow Color", "name"=>'glow_color', "type"=>"text", "section"=>"Button Common Settings","group"=>"Glow",  "css_property"=>"glow", "value"=> ""), 			
			array("label"=>"Texture", "name"=>'texture', "type"=>"select", "section"=>"Button Common Settings", "value"=> "", 
				"list"=> array("no"=>"No", "noise.png"=>"Noise", "checks.png"=>"Checks", "checks_small.png"=>"Checks Small")),								
			array("label"=>"Display", "name"=>'display', "type"=>"select", "section"=>"Button Common Settings", "css_property"=>"display", "value"=> "", 
				"list"=> array("inline-block"=>"Inline Block ","block"=>"Block")),	
					
			array("label"=>"Text Color", "name"=>'text_color', "type"=>"text", "section"=>"Button Normal Settings", "css_property"=>"color", "value"=> ""), 
			array("label"=>"Background Color", "name"=>'background_color', "type"=>"text", "section"=>"Button Normal Settings",  "css_property"=>"background-color", "value"=> ""), 
			array("label"=>"Border Color", "name"=>'border_color', "type"=>"text", "section"=>"Button Normal Settings",  "css_property"=>"border-color", "value"=> ""), 				
			
			array("label"=>"Text Color", "name"=>'text_color_h', "type"=>"text", "section"=>"Button Hover Settings", "css_property"=>"color", "value"=> ""), 
			array("label"=>"Background Color", "name"=>'background_color_h', "type"=>"text", "section"=>"Button Hover Settings", "css_property"=>"background-color", "value"=> ""),
			array("label"=>"Border Color", "name"=>'border_color_h', "type"=>"text", "section"=>"Button Hover Settings", "css_property"=>"border-color", "value"=> ""),
			
			array("label"=>"Text Color", "name"=>'text_color_a', "type"=>"text", "section"=>"Button Active Settings", "css_property"=>"color", "value"=> ""), 
			array("label"=>"Background Color", "name"=>'background_color_a', "type"=>"text", "section"=>"Button Active Settings", "css_property"=>"background-color", "value"=> ""),
			array("label"=>"Border Color", "name"=>'border_color_a', "type"=>"text", "section"=>"Button Active Settings", "css_property"=>"border-color", "value"=> ""),
		);

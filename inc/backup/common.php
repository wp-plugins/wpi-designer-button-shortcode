...
class WPiDesButCommon{
	...
	public static function get_styles(){		
		...
		foreach($preset_styles as $style_id){					
			$output.="<div class='wpi_style_holder'><div id='wpi_db_sty_preset_style_".$style_id."' class='wpi_style wpi_designer_button wpi_designer_button_preset_style_".$style_id."' >Button <span class='wpi_id'>preset_style_".$style_id."</span></div></div>";		
		}*/
	...
	public static function get_help_tab($args){
		...
		$note="<div class='wpi_notes wpi_pn'><div class='wpi_notes_content'><span class='wpi_icon wpi_icon_book wpi_no_text'><i></i></span>".$content."</div>".$nav."</div>";
		$help=$popup.$note;	
		return $help;
	}
}

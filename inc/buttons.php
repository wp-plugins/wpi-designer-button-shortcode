...
class WPiDesBut{	
	...
	public function fields(){
		...
		$fields=array(		
			array("label"=>"Style Id", "name"=>'style_id', "type"=>"select",  "section"=>"Button Settings",  "group"=>"Style","value"=> "", "list"=> $style_ids),
			array("label"=>"Button Text", "name"=>'text', "type"=>"text",  "section"=>"Button Settings", "group"=>"Text", "value"=> ""),
			array("label"=>"Icon", "name"=>'icon', "type"=>"select",  "section"=>"Button Settings", "group"=>"Text", "value"=> "", "list"=> $icons),
			array("label"=>"Link", "name"=>'link', "type"=>"text", "section"=>"Button Settings", "group"=>"Link", "value"=> ""),
